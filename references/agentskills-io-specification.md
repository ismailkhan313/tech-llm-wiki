...
description: The open Agent Skills format specification — the skill directory layout, SKILL.md frontmatter fields and their constraints, the scripts/references/assets conventions, progressive-disclosure budgets, file-reference rules, and validation.
tags: [source, agent-skills, skills, specification, standards, progressive-disclosure]
