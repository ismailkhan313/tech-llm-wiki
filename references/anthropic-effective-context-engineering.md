...
description: Anthropic's Applied AI team on curating and managing the finite context that powers agents — context rot and the attention budget, the anatomy of effective context, just-in-time retrieval, and compaction, note-taking, and sub-agents for long-horizon tasks.
tags: [source, context-engineering, prompt-engineering, agents, anthropic]
resource: https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents
author: team:anthropic-applied-ai
fidelity: verbatim
...
<!--
VERBATIM prose, published 2025-09-29. Every sentence, heading, and list entry
is unmodified. Dropped: site chrome (nav, footer, newsletter form) and the two
inline diagram images. Inline links were converted to markdown links with their
original targets preserved; the one figure caption that survives as body text is
marked as such. Three `###` headings (Compaction, Structured note-taking,
Sub-agent architectures) lost their markup in extraction and were restored.

Two link oddities below are the source's own, left as published: "CLAUDE.md"
is auto-linked to http://claude.md, and "Sonnet 4.5 launch" points back at this
same article rather than the launch post.
-->
...
> *[Figure caption]* At one end of the spectrum, we see brittle if-else hardcoded prompts, and at the other end we see prompts that are overly general or falsely assume shared context.
