...
description: The MCP documentation's introduction page — the USB-C analogy, what MCP enables, why it matters to developers, applications and end users, and its ecosystem support.
tags: [source, mcp, protocols, agents, tools]
...
scrape. Documentation version 2026-07-28.

Unmodified except: the site-injected "Documentation Index" blockquote at the
top was dropped. Mintlify MDX components (<Frame>, <CardGroup>, <Card>) are
left exactly as published, so the card links below are relative to
