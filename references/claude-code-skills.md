...
description: The Claude Code skills documentation — bundled skills, where skills live and how name conflicts resolve, the full frontmatter reference including the Claude Code extensions, invocation control, arguments and string substitutions, dynamic context injection, forked subagent skills, sharing, evaluation, and troubleshooting.
tags: [source, agent-skills, skills, claude-code, anthropic, plugins, slash-commands]
...
path with a `.md` suffix. The three-line "Documentation Index" banner the site
prepends for automated fetchers was dropped; body otherwise unmodified, MDX
components and relative /docs/ links included.
-->
