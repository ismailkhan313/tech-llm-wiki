...
description: The Agent Skills project's authoring guide — grounding skills in real expertise, refining with real execution, spending context wisely, scoping skills as coherent units, calibrating control to task fragility, and the instruction patterns (gotchas, templates, checklists, validation loops, plan-validate-execute, bundled scripts).
tags: [source, agent-skills, skills, best-practices, evaluation, standards]
resource: https://agentskills.io/skill-creation/best-practices
author: org:agentskills
fidelity: verbatim
