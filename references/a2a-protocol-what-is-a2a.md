...
type: Reference
title: "What is A2A?"
description: The A2A (Agent2Agent) protocol's own introduction — the problems it solves, its core benefits and design principles, how it relates to MCP and ADK, and the four-step request lifecycle.
tags: [source, agents, protocols, a2a, mcp, interoperability, google]
resource: https://a2a-protocol.org/latest/topics/what-is-a2a/
author: team:a2a-project
fidelity: verbatim
retrieved: 2026-09-06T21:46:47Z
generated: { by: claude-code/opus-5, at: 2026-09-06T21:46:47Z }
status: stable
---

<!--
VERBATIM. Captured from the upstream markdown source backing the rendered page
(a2aproject/A2A, docs/topics/what-is-a2a.md), which matches the published page
text sentence for sentence. Two mechanical changes only: the three image
references had their `../assets/` relative paths absolutized against
https://a2a-protocol.org/latest/ and their MkDocs `{ width=... }` attribute
blocks dropped, and the two intra-docs links (a2a-and-mcp.md, key-concepts.md)
were absolutized to their published URLs. Prose, headings, lists, and the
mermaid blocks are unmodified.
-->
...
![ADK versus MCP](https://a2a-protocol.org/latest/assets/agentic-stack.png)
...
![ADK + MCP](https://a2a-protocol.org/latest/assets/a2a-mcp-readme.png)
...
For a more in-depth comparison, refer to the [A2A and MCP Comparison](https://a2a-protocol.org/latest/topics/a2a-and-mcp/) document.
...
Learn about the [Key Concepts](https://a2a-protocol.org/latest/topics/key-concepts/) that form the foundation of the A2A protocol.
